...
class Pong_Q_fun(nn.Module):
    ...
    def copy(self):
        copy = Pong_Q_fun(self.state_shape,self.n_actions)
        copy.load_state_dict(self.state_dict())
        return copy
    

class Pong_Agent(agent.Agent):
    def __init__(self):
        env_name = 'ALE/Pong-v5'
        super().__init__(env_name,Pong_Q_fun)
    ...
    def save(self,name):
        fd = f'/home/cody/Documents/DataSciBC/GameRFL/Pong/saved_models/{name}'
        super().save(fd)
